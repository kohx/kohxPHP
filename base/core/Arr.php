...
class Arr {
    ...
    public static function pluck($array, $key, $index_key = null)
    {
    ...
    public static function sort($array, $key, $direction = 'asc', $type = SORT_NUMERIC)
    {
        if ($direction == 'asc')
        {
            $direction = SORT_ASC;
    ...
    public static function map($array, callable $callbacks, $targets = null)
    {        
